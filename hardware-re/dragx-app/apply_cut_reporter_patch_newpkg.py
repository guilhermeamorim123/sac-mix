...
into decoded_newpkg: they fire on every real cut regardless of the
vendor's own (already-bypassed) billing-mode setting.

Run against decoded_newpkg/ before rebuilding the APK:
    python apply_cut_reporter_patch.py
"""
import pathlib

ROOT = pathlib.Path(__file__).parent / "decoded_newpkg" / "smali" / "cn" / "upus" / "app" / "upprinting" / "dragx" / "ui" / "activity"
